...
var host = require('../')
var extensionTypes = ['source', 'versioning', 'deployment', 'config']
...
module.exports = {
  ...
  loadAll: function (names, extensionType) {
    return new Promise(function (resolve, reject) {
      module.exports.connectSingle(extensionType, false).then(function (plugins, pluginNames) {
        var results = {};
        ...
        if (results) {
          ...
          reject(new Error('No matching plugins could be loaded'))
        }
      })
    })
  },
